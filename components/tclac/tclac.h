...
class tclacClimate : public climate::Climate, public esphome::uart::UARTDevice, public PollingComponent {
	...
	public:
		...
		static std::string getHex(byte *message, byte size);
	...
	protected:
		...
		esphome::climate::ClimateModeMask supported_modes_{};
		esphome::climate::ClimatePresetMask supported_presets_{};
		AirflowVerticalDirection vertical_direction_;
		esphome::climate::ClimateFanModeMask supported_fan_modes_{};
		AirflowHorizontalDirection horizontal_direction_;
		VerticalSwingDirection vertical_swing_direction_;
		esphome::climate::ClimateSwingModeMask supported_swing_modes_{};
